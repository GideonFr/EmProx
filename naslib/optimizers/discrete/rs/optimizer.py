...
class RandomSearch(MetaOptimizer):
    ...
    def new_epoch(self, e):
        ...
        ### OWN CODE ### 
        # Train model instead of query
        
        # model.arch.parse()
        # model.arch.train()
        # model.arch = model.arch.to(self.device)
        # self.sampled_archs.append(model.arch)
        # self.weight_optimizers.append(self.weight_optimizer(model.arch.parameters(), 0.01))
